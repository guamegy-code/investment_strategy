...
| 2026-09-11 | 퇴직연금 밸류에이션 방어 | 15번의 단일 네 상태 추세 엔진에 25번 밸류에이션 방어를 결합한 후보가 전체·개발·최근 CAGR과 MDD를 함께 개선 | 15번 유지, 별도 전략 26 신규 반영 | [26번 퇴직연금 밸류에이션 방어 검증](strategy26-retirement-valuation-defense.md) |
| 2026-09-14 | 25·26번 비대칭 리밸런싱 밴드 | QQQ 과대비중 +7.5%p·과소비중 -4%p 후보가 두 전략의 CAGR을 소폭 높이고 MDD를 악화하지 않았지만 유효 사건은 1~2건뿐 | 전략 25·26 버전 2에 반영 | [25·26번 비대칭 리밸런싱 밴드 검증](strategy25-26-asymmetric-rebalance-band.md) |
| 2026-09-20 | 28번 WARNING 하락 매수 | WARNING에서 BIL 30%를 확보하고 -10% 하락 시 QQQ 100%로 즉시 복귀해 전체 CAGR +0.030%p와 MDD +0.833%p를 확인 | 버전 2에 즉시복귀 튜닝 반영, 2020년 단일 진입 의존성 명시 | [28번 밸류에이션 WARNING 하락 매수 검증](strategy28-warning-dip-buyer.md) |
